...
def test_direct_weasyprint_wheel_builds_document() -> None:
    ...
    # Deliberately use the default full_fonts=False path. This exercises
    # HarfBuzz subsetting instead of avoiding it with full_fonts=True.
    HTML(filename=str(HERE / "document.html"), base_url=str(HERE)).write_pdf(output_pdf)
